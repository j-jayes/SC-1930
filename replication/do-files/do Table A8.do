...
/////////////////////////////////////////
/////// Table A8: Results with Regression Weighted by Parish Population

** run regressions and save results for esttab table 

* (1) Log(1+Total Strikes)	
xtreg lstrikes i.year iline iline_owl i.irail L10.llabforce L10.shc2-shc7 i.county_id#i.year [aw=pop_weight], fe vce(cluster parish_code)
est sto lstrikes

* (2) Log(1+Offensive Strikes)	
xtreg lstrikesoff i.year iline iline_owl i.irail L10.llabforce L10.shc2-shc7 i.county_id#i.year [aw=pop_weight], fe vce(cluster parish_code)
est sto lstrikesoff

* (3) Log(1+Defensive Strikes)	
xtreg lstrikesdef i.year iline iline_owl i.irail L10.llabforce L10.shc2-shc7 i.county_id#i.year [aw=pop_weight], fe vce(cluster parish_code)
est sto lstrikesdef

* (4) Log(1+No. of striking workers)	
xtreg lstrikingworkers i.year iline iline_owl i.irail L10.llabforce L10.shc2-shc7 i.county_id#i.year [aw=pop_weight], fe vce(cluster parish_code)
