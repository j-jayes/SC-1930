...
use "data/data Figure 3 and Table A3", clear
...
/////////////////////////////////////////
/////// Figure 3 and Table A3: Regression Results for Change in Occupational Groups’ Shares

** run regressions and save results for esttab table and figure

foreach var of varlist shc1-shc7 {
...
esttab shc1 shc2 shc3 shc4 shc5 shc6 shc7, drop(*.year *year _cons) s(N , labels("Observations")) ///
mlabels("(1) Elite" "(2) White collar" "(3) Foremen" "(4) Medium skilled" "(5) Farmers" "(6) Lower skilled" "(7) Unskilled") se

* graph regresison results (figure 3)
...
ylabel(1 "1. Elite" 2 "2. White collar" 3 "3. Foremen" 4 "4. Medium skilled" 5 "5. Farmers" 6 "6. Lower skilled" 7 "7. Unskilled", angle(0) labsize(medium)) yscale(reverse) ytitle("") xtitle("Percentage point change (%)", size(medium)) ///
legend(off) xlabel(-5(2.5)5, labsize(medium)) ysize(12) xsize(20)
