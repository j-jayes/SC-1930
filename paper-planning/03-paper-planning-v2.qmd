...
tab_res_multi_250_inc_1 %>% 
  ...
  gt::gtsave("tables/tab_res_multi_250_inc_1.tex")
...
```{r}
parishes_1900 <- haven::read_dta(here::here("replication", "data", "data Table 2.dta"))

parishes_1900 <- parishes_1900 %>% 
  mutate(scbkod = as.numeric(str_remove(parish_code, "\\d\\d\\d$")))

df_reg_250 <- df_reg_250 %>% 
  left_join(parishes_1900)

res_multi_250_inc_1_shc <- feols(log_income_incl_zero ~ electricity_parish_born*lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + csw0(hisclass_group_abb, schooling_abb, dist_bp_to_cp_km), df_reg_250)
...
rows <- tribble(
  ~term,
  ~`rhs: electricity_parish_born + lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + electricity_parish_born:lives_in_parish_of_birth`,
  ~`rhs: electricity_parish_born + lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + hisclass_group_abb + electricity_parish_born:lives_in_parish_of_birth`,
  ~`rhs: electricity_parish_born + lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + hisclass_group_abb + schooling_abb + electricity_parish_born:lives_in_parish_of_birth`,
  ~`rhs: electricity_parish_born + lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + hisclass_group_abb + schooling_abb + dist_bp_to_cp_km + electricity_parish_born:lives_in_parish_of_birth`,
  "Age, Age^2, Gender,Parish controls 1900 ", "X", "X", "X", "X",
  "Hisclass", "", "X", "X", "X",
  "Schooling", "", "", "X", "X",
  "Distance from birth parish to current parish", "", "", "", "X"
...
# modelsummary(res_multi_250_inc_1_shc)

tab_res_multi_250_inc_1_shc <- modelsummary(res_multi_250_inc_1_shc,
                    stars = TRUE,
                    coef_map = cm,
                    add_rows = rows,
                    output = "gt")

tab_res_multi_250_inc_1_shc %>% 
  cols_label(
    `rhs: electricity_parish_born + lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + electricity_parish_born:lives_in_parish_of_birth` = "OLS 1",
    `rhs: electricity_parish_born + lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + hisclass_group_abb + electricity_parish_born:lives_in_parish_of_birth` = "OLS 2",
    `rhs: electricity_parish_born + lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + hisclass_group_abb + schooling_abb + electricity_parish_born:lives_in_parish_of_birth` = "OLS 3",
    `rhs: electricity_parish_born + lives_in_parish_of_birth + age + age_2 + female + shc1 + shc2 + shc3 + shc4 + shc5 + shc6 + shc7 + hisclass_group_abb + schooling_abb + dist_bp_to_cp_km + electricity_parish_born:lives_in_parish_of_birth` = "OLS 4"
  ) %>%
  tab_spanner(
    label = md("Outcome var: **log income (incl zero)**"),
    columns = -1
  ...
  gt::gtsave("tables/tab_res_multi_250_inc_1_shc.tex")
...
### Now making it for kable extra output
...
table %>% as_tibble() %>% kableExtra::kable(format = "latex")
