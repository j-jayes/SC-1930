...
```{r}
reg_out <- feols(log_income ~ electricity_parish_born + hisclass_group_abb + schooling_abb + age + age_2 + female, data = df_reg)
...
```{r}
reg_out <- feols(log_income ~ electricity_parish_born + age + age_2 + female, data = df_reg)
