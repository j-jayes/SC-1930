...
reg_out <- lm(inkomst ~ lives_in_parish_of_birth + hisclass_group_abb + schooling_abb + age + age_2 + female, data = df_reg)

reg_out <- feols(inkomst ~ lives_in_parish_of_birth + hisclass_group_abb + schooling_abb + age + age_2 + female, data = df_reg)
...
```{r}
reg_out <- feols(inkomst ~ lives_in_parish_of_birth*electricity_parish_living_in + hisclass_group_abb + schooling_abb + age + age_2 + female, data = df_reg)
...
```{r}
reg_out <- feols(inkomst ~ lives_in_parish_of_birth*electricity_parish_living_in + hisclass_group_abb + schooling_abb + age + age_2 + female | scbkod, data = df_reg)
...
```{r}
reg_out <- feols(inkomst ~ dist_bp_to_cp_km*electricity_parish_living_in + hisclass_group_abb + schooling_abb + age + age_2 + female, data = df_reg)
...
```{r}
reg_out <- lm(inkomst ~ electricity_parish_born + dist_bp_to_cp_km + hisclass_group_abb + age + female, data = df_reg)
